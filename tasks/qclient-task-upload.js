...
module.exports = function(grunt) {
	...
	grunt.registerMultiTask('qclient-task-upload', 'Upload file to cdn', function() {
		...
		var options = this.options({
			tuchuang_sync : 'http://api.v3.picasso.qhimg.com/v3/app/test/upload_pics/',
			tuchuang_async : 'http://api.v3.picasso.qhimg.com/v3/app/test/tasks/',
			tuchaung_query : 'http://api.v3.picasso.qhimg.com/v3/app/test/query_tasks/',
			jingchaung_sync : 'http://qstatic.corp.qihoo.net:8360/pub'
		});
